...
public class DominioDeformacao {
    ...
    public double obterElevacaoContinental(double x, double z) {
		...
		double offsetX = ruido1.ruidoFractal(x * 0.0002, z * 0.0002, 2, 0.5, 2.0) * 400.0;
		double offsetZ = ruido1.ruidoFractal(x * 0.0002 + 1000, z * 0.0002 + 1000, 2, 0.5, 2.0) * 400.0;

		double xFinal = x + offsetX;
		double zFinal = z + offsetZ;
