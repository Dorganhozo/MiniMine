...
public class TesteUI implements Screen, InputProcessor {
    ...
    public void show() {
		...
		Texture cuboTexture = new Texture(Gdx.files.internal("ui/focado.png"));
		Material material = new Material(new TextureAttribute(TextureAttribute.Diffuse, cuboTexture));

		ModelBuilder mb2 = new ModelBuilder();
		modelo = mb2.createBox(5f, 5f, 5f, material, Usage.Position | Usage.Normal | Usage.TextureCoordinates);
